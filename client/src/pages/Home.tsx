    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      <nav className="bg-slate-900/50 backdrop-blur border-b border-slate-700">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold text-white">📸 Driveway Estimator Pro</div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-20 md:py-32">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            Take a photo, get AI-powered measurements, visualize materials, and share estimates with contractors—all from your phone.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent>
              <p className="text-slate-400">Take photos of your driveway using your device camera or upload existing images.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent>
              <p className="text-slate-400">Automatically detect driveway boundaries and calculate square footage with AI vision.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent>
              <p className="text-slate-400">Get accurate material costs based on your location and current regional prices.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent>
              <p className="text-slate-400">Generate shareable links and send estimates to contractors with a single click.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-lg p-12 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {[
              { step: 1, title: "Capture", desc: "Take a photo of your driveway" },
              { step: 2, title: "Adjust", desc: "Refine corner points if needed" },
              { step: 3, title: "Select", desc: "Choose your material type" },
              { step: 4, title: "Preview", desc: "See the finished result" },
              { step: 5, title: "Share", desc: "Send to contractors instantly" },
            ].map((item, i) => (
        ...
        {/* Materials */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Supported Materials</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <Card key={i} className="bg-slate-800 border-slate-700 text-center">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-12 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-xl mx-auto">
            Create your first driveway estimate today and see how easy it is to measure and visualize your project.
          </p>
          {isAuthenticated ? (
            <Link href="/estimator">
              <Button size="lg" className="bg-white hover:bg-slate-100 text-blue-600 font-semibold px-8 py-6">
                Start Estimating
              </Button>
            </Link>
          ) : (
